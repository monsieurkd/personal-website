        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">About the Author</h4>
                <p className="text-gray-700 dark:text-gray-300 mb-4">
                  Your Name is a passionate full-stack developer with over 3 years of experience in building modern web applications. 
                  He specializes in React, Next.js, and Node.js, and loves sharing knowledge about web development best practices.
                </p>
                <div className="flex gap-4">
